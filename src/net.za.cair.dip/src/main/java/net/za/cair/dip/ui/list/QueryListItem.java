...
public class QueryListItem implements MListItem{
    private OWLAxiom axiom;
    private OWLModelManager modelManager;
    
    public QueryListItem(OWLAxiom axiom, OWLModelManager modelManager, OWLEditorKit editorKit) {  
    ...
    public boolean handleDelete(){
    	...
    	u.removeQuery(modelManager, modelManager.getActiveOntology(), getOWLAxiom());
    	return true;
    }
