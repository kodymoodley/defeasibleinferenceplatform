...
public class RankingAxiomsListSection implements MListSectionHeader {

    private String label;

    public RankingAxiomsListSection(String label) {
        this.label = label;
    }

    public RankingAxiomsListSection(ReasoningType reasoningType) {
        this.label = reasoningType.getName();
    }
