...
public class StrictAxiomListItem extends AbstractOWLFrameSectionRow<OWLOntology, OWLAxiom, OWLAxiom> implements MListItem{
    ...
    public StrictAxiomListItem(OWLAxiom axiom, OWLModelManager modelManager, OWLEditorKit editorKit) {  
